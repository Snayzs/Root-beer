class Scores {
  ...
  setHighScores() {
    let current_highScores = localStorage.getItem('root_bear_highScores') || 0
    if (this.totalPoint > current_highScores) {
      localStorage.setItem('root_bear_highScores', this.totalPoint)
    }
  }
